---
title: "Introduction to biocthisexample"
author: 
  - name: Your name
    affiliation:
    - Your institution
...
vignette: >
  %\VignetteIndexEntry{Introduction to biocthisexample}
...
write.bibtex(bib, file = "biocthisexample.bib")
```
...
## Create the vignette
library("rmarkdown")
system.time(render("biocthisexample.Rmd", "BiocStyle::html_document"))

## Extract the R code
library("knitr")
knit("biocthisexample.Rmd", tangle = TRUE)
```

```{r createVignette2}
## Clean up
file.remove("biocthisexample.bib")
```
